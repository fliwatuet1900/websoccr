...
echo FormBuilder::createFormGroup($i18n, 'message_id', array('type' => 'foreign_key', 'jointable' => 'spiel_text',
		'entity' => 'matchtext', 'labelcolumns' => 'aktion,nachricht'), '', 'match_manage_reportmsg_');
